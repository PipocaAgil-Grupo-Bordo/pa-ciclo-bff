          ...
          <div style="background-color: #f5f5f5; padding: 20px;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #fff; border-radius: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
              <div style="padding: 20px;">
                ...
                <p>Olá <strong style="color: #007bff;">${user.name}</strong>,</p>
                ...
                <div style="background-color: #007bff; color: #fff; padding: 10px; border-radius: 5px; margin-top: 20px; text-align: center;">
                ...
                <p style="margin-top: 20px;">Atenciosamente,<br><strong style="color: #007bff;">Equipe Ciclo Ágil</strong></p>
              </div>
            </div>
          </div>
        </body>
