...
export class CreateProfileAndMenstrualPeriod1713290354760 implements MigrationInterface {
    name = 'CreateProfileAndMenstrualPeriod1713290354760'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "profile" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "height" integer, "weight" double precision, "isMenstrualCycleRegular" boolean DEFAULT true, "menstrualCycleDuration" integer, CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
